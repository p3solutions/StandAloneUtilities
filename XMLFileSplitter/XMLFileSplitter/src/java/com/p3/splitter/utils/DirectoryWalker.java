 ...
 *
 *
 *  This class is used to Walk a Directory and Return a List of all Files in a Directory.
 *
 *@author     Malik
 *@version    1.0
 *
...
public class DirectoryWalker {
  ...
  /**
    ...
    *
    * @param source - The String version of the Source File directory to walk
    *
   ...
   public synchronized List<String> walk(String source) throws IOException {
	   ...
	   System.out.println("Done Walking through directory.");
	   return m_fileList;
   }
    ...
    /**
     *  walk  - private method to Walk a Directory and
     *     Return a List of all Files in a Directory.
     *
     * @param source - The File version of the Source File directory to walk
     *
     */
