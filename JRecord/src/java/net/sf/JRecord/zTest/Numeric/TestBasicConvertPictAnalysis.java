...
public class TestBasicConvertPictAnalysis  extends TestCase{
	...
	public void testNumericPictures() {
		...
		chkPict("999.99-", Type.ftSignSepTrailActualDecimal);
		chkPict("999-", Type.ftSignSeparateTrail);
		chkPict(".999-", Type.ftSignSepTrailActualDecimal);
		chkPict("999.99+", Type.ftSignSepTrailActualDecimal);
		chkPict("999+", Type.ftSignSeparateTrail);
		chkPict(".999+", Type.ftSignSepTrailActualDecimal);
		chkPict("Z.999-", Type.ftSignSepTrailActualDecimal);
		chkPict("Z99.9-", Type.ftSignSepTrailActualDecimal);
