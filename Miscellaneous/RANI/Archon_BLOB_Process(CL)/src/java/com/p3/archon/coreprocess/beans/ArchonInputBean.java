...
public class ArchonInputBean {
	...
	@Option(name = "-ext", aliases = { "--extention" }, usage = "extention")
	public String extention;

	@Option(name = "-aa", aliases = { "--additianalQuery" }, usage = "additianalQuery")
	public String additianalQuery;
	
	@Option(name = "-fp", aliases = { "--filePath" }, usage = "filePath")
	public String filePath;

	public String getAdditianalQuery() {
		return additianalQuery;
	}

	public void setAdditianalQuery(String additianalQuery) {
		this.additianalQuery = additianalQuery;
	}
