...
@Entity
@Table(name = "USER_DETAILS", indexes = { @Index(name = "user_details_index", columnList = "REQ_ID"),
		@Index(name = "user_details_index1", columnList = "USER_ID"),
		@Index(name = "user_details_index2", columnList = "STATUS"),
		@Index(name = "user_details_index3", columnList = "EMAIL"),
		@Index(name = "user_details_index4", columnList = "ROLE") })
