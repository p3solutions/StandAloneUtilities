...
@Entity
@Table(name = "MAINFRAMEDB2_METALYZER_SESSIONS", indexes = { @Index(name = "mainframedb2_ma_index", columnList = "USER_ID"),
		@Index(name = "mainframedb2_ma_index1", columnList = "HOST"), @Index(name = "mainframedb2_ma_index2", columnList = "PORT"),
		@Index(name = "mainframedb2_ma_index3", columnList = "LIB"),
		@Index(name = "mainframedb2_ma_index4", columnList = "USER_NAME"),
		@Index(name = "mainframedb2_ma_index5", columnList = "BASE_IND") })
@org.hibernate.annotations.Entity(dynamicUpdate = true)
public class MainFrameDB2MetalyzerSessions {
