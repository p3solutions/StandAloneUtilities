...
public class ArchonInputBean {
	...
	@Option(name = "-loc", aliases = { "--loc" }, usage = "Location", required = true)
	...
	@Option(name = "-aa", aliases = {
			"--additionalquery" }, usage = "manual mode representing the inputs provided in command line")
	public String additionalArguments;

	@Option(name = "-xsl", aliases = { "--xslPath" }, usage = "XSL")
